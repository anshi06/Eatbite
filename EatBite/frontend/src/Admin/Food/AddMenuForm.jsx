            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                <FormControl fullWidth variant="outlined">
                  ...
                  >
                    {restaurant?.categories?.length ? restaurant.categories.map((item) => (
                      <MenuItem value={item}>{item.name}</MenuItem>
                    )) : <p className="font-semibold text-amber-400">Please add category for your restaurant before adding items into menu.</p>}
                  </Select>
                </FormControl>
              </Grid>
              ...
              <Grid item xs={12}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    MenuProps={MenuProps}
                  >
                    {ingredients.ingredients.length ? ingredients.ingredients?.map((item) => (
                      <MenuItem
                        key={item._id}
                        value={item}
                    ...
                    )): <p className="font-semibold text-amber-400">Please add ingredients for your restaurant before adding items into menu.</p>}
                  </Select>
                </FormControl>
              </Grid>
