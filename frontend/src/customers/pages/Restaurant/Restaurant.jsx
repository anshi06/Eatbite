      ...
      <div className="px-2 lg:px-20 ">
        <section>
          <h3 className="text-gray-500 py-2 mt-10">
            ...
            {restaurant.restaurant?.name}/{restaurant.restaurant?._id}/Order
            Online
          </h3>
          <div>
          ...
          <div className="pt-3 pb-5">
            ...
            <div className="space-y-3 mt-3">
              <p className="text-gray-500 flex items-center gap-3">
                <Phone />{" "}
                <span>{restaurant.restaurant?.contactInformation?.mobile}</span>
              </p>
        ...
        <section className="pt-[1rem] lg:flex relative ">
          <div className="space-y-9 lg:w-[18%] filter">
          ...
          <div className="lg:w-[80%] space-y-5 lg:pl-10">
            {menu?.menuItems?.length ? (
              menu?.menuItems.map((item) => <MenuItemCard item={item} />)
            ) : (
              <p className="text-center text-red-400">
                Sorry, no items available under this category at the moment.
              </p>
            )}
          </div>
        </section>
